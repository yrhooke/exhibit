...
urlpatterns = [
    ...
    path('artwork/image/new', views.ImageView.as_view(), name="artwork_image_upload"),
    # path('artwork/image/<int:pk>', views.artworkimage, name="artwork_image"),
    path('series/', views.SeriesList.as_view(), name="series_index"),
    path('series/new/', views.SeriesView.as_view(), name='series_new'),
    path('series/<int:pk>/', views.SeriesView.as_view(), name='series_detail'),
    path('series/<int:pk>/delete/', views.SeriesView.as_view(), name='series-delete'),
